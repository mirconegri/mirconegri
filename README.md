...
|  [****](https://github.com/mirconegri/) | An automated algorithmic trading script executing a Cross-Sectional Momentum strategy on top US Tech stocks via the Alpaca API | Python |
